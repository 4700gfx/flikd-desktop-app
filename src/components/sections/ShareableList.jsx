        ...
        <div className='flex items-center gap-1.5 flex-shrink-0'>
          ...
          {isOwner && (
            <button
              ...
              disabled={removing}
              className='w-8 h-8 rounded-xl border border-transparent text-white/20 hover:border-red-500/25 hover:text-red-400/60 hover:bg-red-500/6 transition-all duration-200 flex items-center justify-center'>
              {removing
