...
const LogInPage = () => {
  ...
  // Handle Changes While Inputting Data 
      ...
      <div className='login-container flex flex-row w-full max-w-5xl min-h-[650px] rounded-3xl overflow-hidden shadow-2xl backdrop-blur-sm bg-white/5 relative z-10'>
        ...
        <div className='image-panel bg-gradient-to-br from-flikd-gold via-flikd-gold to-yellow-500 w-1/2 p-12 flex flex-col justify-between relative overflow-hidden hidden lg:flex'>
          ...
          <div className='relative z-10'>
            ...
            <p className='font-bebas text-3xl text-flikd-black/90 max-w-md leading-relaxed'>
              Your New Favorite Review Application
            </p>
            <p className='font-inter text-md'>  
              Created for Show Lovers and Movies Lovers that would love to track, share and review their favorite shows and moves that are out today. Our Rotten Tomatos meets Meta.      
            </p>
          </div>
        ...
        {/* Right Panel - Form */}
        <div className='bg-white w-full lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center overflow-y-auto'>
          <div className='max-w-md mx-auto w-full'>
            ...
            <div className='mb-8'>
              ...
              <p className='font-inter text-gray-500 text-base'>
                {isResetPassword 
                  ...
                  : isSignUp 
                  ? 'Join the Flik\'d community today' 
            ...
            <form onSubmit={handleSubmit} className='space-y-5'>
              ...
              {isResetPassword && (
                <button
                  ...
                  disabled={loading}
                  className='w-full font-inter text-sm text-gray-600 hover:text-flikd-gold font-medium transition-colors mt-3'
                >
                  ← Back to sign in
                </button>
              )}
            ...
            {/* Divider - not shown for reset password */}
            {!isResetPassword && (
              <>
